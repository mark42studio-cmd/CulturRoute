...
export default function EventBrowser({ initialEvents }: { initialEvents: Event[] }) {
  ...
  const DISTRICT_KEYWORDS = {
    city:     ['台東市', '臺東市', '市區', '設計中心', '鐵花', '美術館', '藝文中心', '美學館', '波浪屋', '史前', '更生路', '正氣路', '中山路', '中華路'],
    sea:      ['東河', '成功', '長濱', '三仙台', '都蘭', '加路蘭', '金樽', '比西里岸', '杉原', '富岡', '海岸', '海線', '小馬', '石雨傘', '泰源', '宜灣', '靜浦', '磯崎'],
    mountain: ['鹿野', '關山', '池上', '延平', '海端', '初鹿', '伯朗大道', '高台', '縱谷', '山線', '瑞源', '瑞穗', '六十石山', '電光', '永安'],
    south:    ['太麻里', '金峰', '大武', '達仁', '多良', '知本', '南迴', '大鳥', '金崙', '大溪', '富山'],
    island:   ['綠島', '蘭嶼'],
    other:    [] as string[],
  } as const;
